...
/**
 * @component @name ArrowUpSCDuotone
 ...
 * @see https://foamicons.com/icons/arrow-up-scduotone
 *
 ...
 */
export const ArrowUpSCDuotone = createFoamicon('ArrowUpSCDuotone', __iconNode);
