...
/**
 * @component @name TrendingDownDuotone
 ...
 * @see https://foamicons.com/icons/trending-down-duotone
 *
 ...
 */
export const TrendingDownDuotone = createFoamicon('TrendingDownDuotone', __iconNode);
