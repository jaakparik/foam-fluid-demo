...
/**
 * @component @name TrendingDownFill
 ...
 * @see https://foamicons.com/icons/trending-down-fill
 *
 ...
 */
export const TrendingDownFill = createFoamicon('TrendingDownFill', __iconNode);
