...
/**
 * @component @name ChevronDownDuotone
 ...
 * @see https://foamicons.com/icons/chevron-down-duotone
 *
 ...
 */
export const ChevronDownDuotone = createFoamicon('ChevronDownDuotone', __iconNode);
