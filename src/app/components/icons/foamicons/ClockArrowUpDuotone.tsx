...
/**
 * @component @name ClockArrowUpDuotone
 ...
 * @see https://foamicons.com/icons/clock-arrow-up-duotone
 *
 ...
 */
export const ClockArrowUpDuotone = createFoamicon('ClockArrowUpDuotone', __iconNode);
