...
/**
 * @component @name RemoveFormattingDuotone
 ...
 * @see https://foamicons.com/icons/remove-formatting-duotone
 *
 ...
 */
export const RemoveFormattingDuotone = createFoamicon('RemoveFormattingDuotone', __iconNode);
