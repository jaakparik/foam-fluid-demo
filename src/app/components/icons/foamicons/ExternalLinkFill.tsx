...
/**
 * @component @name ExternalLinkFill
 ...
 * @see https://foamicons.com/icons/external-link-fill
 *
 ...
 */
export const ExternalLinkFill = createFoamicon('ExternalLinkFill', __iconNode);
