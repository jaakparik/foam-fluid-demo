...
/**
 * @component @name ArrowDownYTDuotone
 ...
 * @see https://foamicons.com/icons/arrow-down-ytduotone
 *
 ...
 */
export const ArrowDownYTDuotone = createFoamicon('ArrowDownYTDuotone', __iconNode);
