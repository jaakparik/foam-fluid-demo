...
/**
 * @component @name ChevronRightFill
 ...
 * @see https://foamicons.com/icons/chevron-right-fill
 *
 ...
 */
export const ChevronRightFill = createFoamicon('ChevronRightFill', __iconNode);
