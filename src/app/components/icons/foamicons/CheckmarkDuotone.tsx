...
/**
 * @component @name CheckmarkDuotone
 ...
 * @see https://foamicons.com/icons/checkmark-duotone
 *
 ...
 */
export const CheckmarkDuotone = createFoamicon('CheckmarkDuotone', __iconNode);
