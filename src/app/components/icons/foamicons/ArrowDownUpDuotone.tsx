...
/**
 * @component @name ArrowDownUpDuotone
 ...
 * @see https://foamicons.com/icons/arrow-down-up-duotone
 *
 ...
 */
export const ArrowDownUpDuotone = createFoamicon('ArrowDownUpDuotone', __iconNode);
