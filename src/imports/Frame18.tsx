import svgPaths from "./svg-tr14iyuvv7";
...
function Logotype() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Logotype">
...
function Frame4() {
  return (
    <div className="bg-[#303d4f] content-stretch flex items-center p-[4px] relative rounded-[4px] shrink-0">
      <Logotype />
    </div>
  );
}
...
function NavAgency() {
  return (
    <div className="content-stretch flex gap-[8px] items-center px-[12px] py-0 relative shrink-0" data-name="nav/agency">
      <Frame4 />
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Home">
          <path d={svgPaths.p19408500} id="Rectangle 519" stroke="var(--stroke-0, #15191E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Persons() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Persons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Persons">
          <circle cx="7.09595" cy="5.6543" id="Ellipse 98" r="2.1582" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="14.043" cy="6.15906" id="Ellipse 99" r="1.65344" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d={svgPaths.p3376ba00} id="Rectangle 520" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <g id="Mask group">
            <mask height="7" id="mask0_1_2470" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="9" x="10" y="9">
              <path d={svgPaths.p20cc8d00} id="Rectangle 521" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
            </mask>
...
function Frame14() {
  return (
    <div className="basis-0 content-stretch flex font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow items-center justify-between leading-[20px] min-h-px min-w-px relative shrink-0">
      <p className="basis-0 grow min-h-px min-w-px relative shrink-0 text-[#54657d] text-[14px]">Talent Directory</p>
      <p className="relative shrink-0 text-[#8b94a2] text-[12px] text-nowrap">456</p>
    </div>
  );
}
...
function Pictures() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Pictures">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Pictures">
          <path d={svgPaths.p330caa00} id="Rectangle 519" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d={svgPaths.p2d219ae0} id="Vector 624" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="13.9062" cy="7.125" fill="var(--fill-0, #54657D)" id="Ellipse 45" r="0.9375" />
          <path d={svgPaths.p1c72f400} id="Vector 684" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function List() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="List">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="List">
          <path d="M6.875 5H16.25" id="Vector 662" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d="M6.875 10H16.25" id="Vector 664" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d="M6.875 15H16.25" id="Vector 663" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Media packs">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Media packs">
          <g id="Group 10">
            <circle cx="12.3863" cy="6.24462" id="Ellipse 99" r="1.16616" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
            <path d={svgPaths.p3cf4d3c0} id="Rectangle 521" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          </g>
          <path d={svgPaths.p1daa3500} fill="var(--stroke-0, #54657D)" id="Rectangle 559" />
          <path d={svgPaths.p1693900} id="Rectangle 560" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Eye() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Eye">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Eye">
          <path d={svgPaths.p490a880} id="Ellipse 38" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="10" cy="10" id="Ellipse 30" r="2.5" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Avatar() {
  return (
    <div className="overflow-clip relative rounded-[2px] shrink-0 size-[24px]" data-name="Avatar">
...
function NavItemRecentProfile() {
  return (
    <div className="h-[28px] relative rounded-[8px] shrink-0 w-full" data-name="nav/item/recent_profile_3">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[2px] pr-[8px] py-[4px] relative size-full">
          <Avatar />
          <Frame5 />
        </div>
      </div>
...
function Bell() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Bell">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Bell">
          <path d={svgPaths.p3346be40} id="Vector" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Cogwheel() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Cogwheel">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Cogwheel">
          <path clipRule="evenodd" d={svgPaths.pdc87380} fillRule="evenodd" id="Union" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="8.02673" cy="7.95832" id="Ellipse 31" r="2" stroke="var(--stroke-0, #54657D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Avatar4() {
  return (
    <div className="bg-[#fbb874] relative rounded-[100px] shrink-0 size-[32px]" data-name="Avatar">
      <div className="absolute flex flex-col font-['Founders_Grotesk:Medium',sans-serif] justify-center leading-[0] left-[16px] not-italic text-[#1c2128] text-[12px] text-center text-nowrap top-[16px] translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[18px]">GB</p>
      </div>
    </div>
  );
}
...
function User() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="user_2">
      <div className="flex flex-row items-center size-full">
