import svgPaths from "@/imports/svg-s874fbaxdy";
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      ...
      >
        <g>
          <g>
            <path d={svgPaths.p208295b0} fill="url(#paint0_linear_ig)" />
            <path d={svgPaths.p208295b0} fill="url(#paint1_linear_ig)" />
          </g>
        </g>
        <defs>
          <linearGradient
    ...
    <div className="relative shrink-0 size-[20px]">
      ...
      >
        <g>
          <path
            clipRule="evenodd"
            d={svgPaths.p2dd0f600}
            fill="var(--fill-0, #00F7EF)"
            fillRule="evenodd"
          />
          <path
            clipRule="evenodd"
            d={svgPaths.p1877ad00}
            fill="var(--fill-0, black)"
            fillRule="evenodd"
          />
          <path
            clipRule="evenodd"
            d={svgPaths.p1a7e8900}
            fill="var(--fill-0, #FF004F)"
            fillRule="evenodd"
          />
        </g>
      </svg>
    ...
    <div className="relative shrink-0 size-[20px]">
      <div className="absolute inset-[0_-0.1%_0_0]">
        <svg
          ...
          fill="none"
          preserveAspectRatio="none"
          viewBox="0 0 20.0198 20"
        >
          <g>
            <path d={svgPaths.p313bff00} fill="var(--fill-0, #FF0302)" />
            <path d={svgPaths.p388c7a00} fill="var(--fill-0, white)" />
          </g>
        </svg>
      </div>
    </div>
      ...
      <div className="absolute inset-[6.25%]">
        ...
        >
          <g>
            ...
            <path d={svgPaths.pf351800} fill="var(--fill-0, white)" />
            <path d={svgPaths.p2fdba100} fill="var(--fill-0, black)" />
          </g>
        </svg>
      </div>
    </div>
