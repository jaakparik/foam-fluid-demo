import svgPaths from "./svg-f40xtueehh";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Logotype">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Logotype">
          <path d={svgPaths.p1dcf7e30} fill="var(--fill-0, #303D4F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame5() {
  return (
    <div className="bg-[#eef3fa] content-stretch flex items-center p-[4px] relative rounded-[8px] shrink-0 size-[28px]">
      <Logotype />
    </div>
  );
}
...
function Nav2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center px-[12px] py-0 relative shrink-0" data-name="nav_3">
      <Frame5 />
      <p className="font-['Hanken_Grotesk:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#eef3fa] text-[16px] text-nowrap">Evergreen Agency</p>
    </div>
  );
}
...
function NavSeparator() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] h-px relative shrink-0 w-full" data-name="nav/separator">
...
function Home() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Home">
          <path d={svgPaths.p1811ef00} id="Rectangle 519" stroke="var(--stroke-0, #F3F5F6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame13() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#f3f5f6] text-[14px]">Dashboard</p>
    </div>
  );
}
...
function NavItemWithIcon1() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-bl-[8px] rounded-br-[2px] rounded-tl-[8px] rounded-tr-[2px] shrink-0 w-full" data-name="nav/item/with_icon_3">
...
function Persons() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Persons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Persons">
          <circle cx="7.09595" cy="5.6543" id="Ellipse 98" r="2.1582" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="14.043" cy="6.15906" id="Ellipse 99" r="1.65344" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d={svgPaths.p3376ba00} id="Rectangle 520" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <g id="Mask group">
            <mask height="7" id="mask0_5_7979" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="9" x="10" y="9">
              <path d={svgPaths.p20cc8d00} id="Rectangle 521" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
            </mask>
            <g mask="url(#mask0_5_7979)">
              <path d={svgPaths.p34a575c0} fill="var(--fill-0, #B7BDC7)" id="Rectangle 561" />
            </g>
          </g>
        </g>
      </svg>
...
function Frame15() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#b7bdc7] text-[14px]">Talent Directory</p>
    </div>
  );
}
...
function Pictures() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Pictures">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Pictures">
          <path d={svgPaths.p330caa00} id="Rectangle 519" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d={svgPaths.p2d219ae0} id="Vector 624" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="13.9062" cy="7.125" fill="var(--fill-0, #B7BDC7)" id="Ellipse 45" r="0.9375" />
          <path d={svgPaths.p1c72f400} id="Vector 684" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame16() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#b7bdc7] text-[14px]">Content Feed</p>
    </div>
  );
}
...
function List() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="List">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="List">
          <path d="M6.875 5H16.25" id="Vector 662" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d="M6.875 10H16.25" id="Vector 664" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d="M6.875 15H16.25" id="Vector 663" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="3.4375" cy="5" fill="var(--fill-0, #B7BDC7)" id="Ellipse 70" r="0.9375" />
          <circle cx="3.4375" cy="10" fill="var(--fill-0, #B7BDC7)" id="Ellipse 71" r="0.9375" />
          <circle cx="3.4375" cy="15" fill="var(--fill-0, #B7BDC7)" id="Ellipse 72" r="0.9375" />
        </g>
      </svg>
    </div>
  );
...
function Frame17() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#b7bdc7] text-[14px]">Lists</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Media packs">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Media packs">
          <g id="Group 10">
            <circle cx="12.3863" cy="6.24462" id="Ellipse 99" r="1.16616" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
            <path d={svgPaths.p3cf4d3c0} id="Rectangle 521" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          </g>
          <path d={svgPaths.p1daa3500} fill="var(--stroke-0, #B7BDC7)" id="Rectangle 559" />
          <path d={svgPaths.p1693900} id="Rectangle 560" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame20() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#b7bdc7] text-[14px]">Media Kits</p>
    </div>
  );
}
...
function Eye() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Eye">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Eye">
          <path d={svgPaths.p490a880} id="Ellipse 38" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="10" cy="10" id="Ellipse 30" r="2.5" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame21() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#b7bdc7] text-[14px]">Scouting Watchlists</p>
    </div>
  );
}
...
function Nav1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="nav_2">
      <p className="font-['Hanken_Grotesk:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#54657d] text-[12px] text-nowrap">RECENT</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px relative shrink-0">
      <p className="font-['Hanken_Grotesk:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#d2ddec] text-[12px] text-nowrap">
...
function Frame10() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px relative shrink-0">
      <p className="font-['Hanken_Grotesk:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#d2ddec] text-[12px] text-nowrap">Sixteenth Roster</p>
    </div>
  );
}
...
function Icon() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path clipRule="evenodd" d={svgPaths.p2170ce00} fill="var(--fill-0, #B7BDC7)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame12() {
  return (
    <div className="content-stretch flex font-['Hanken_Grotesk:Medium',sans-serif] font-medium gap-[2px] items-center leading-[20px] relative shrink-0 text-[12px] text-nowrap">
      <p className="relative shrink-0 text-[#d2ddec]">Project Hail Mary</p>
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[16px] not-italic relative shrink-0 text-[12px] w-[144px]">
      <p className="font-['Founders_Grotesk:Medium',sans-serif] relative shrink-0 text-[rgba(255,255,255,0.9)] w-full">Download Chrome Extension</p>
      <p className="font-['Founders_Grotesk:Regular',sans-serif] relative shrink-0 text-[rgba(255,255,255,0.6)] w-full">Get the full experience</p>
    </div>
  );
}
...
function Nav() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[8px] shrink-0 w-full" data-name="nav">
      <div className="flex flex-row items-center size-full">
...
function Bell() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Bell">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bell">
          <path d={svgPaths.p34917f40} id="Vector" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame24() {
  return (
    <div className="basis-0 content-stretch flex font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow items-center justify-between leading-[20px] min-h-px min-w-px relative shrink-0">
      <p className="basis-0 grow min-h-px min-w-px relative shrink-0 text-[#b7bdc7] text-[14px]">Notifications</p>
      <p className="relative shrink-0 text-[#54657d] text-[12px] text-nowrap">12</p>
    </div>
  );
}
...
function Cogwheel() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Cogwheel">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Cogwheel">
          <path clipRule="evenodd" d={svgPaths.p1e1e1900} fillRule="evenodd" id="Union" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <circle cx="10.0334" cy="9.94791" id="Ellipse 31" r="2.5" stroke="var(--stroke-0, #B7BDC7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame25() {
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Hanken_Grotesk:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#b7bdc7] text-[14px]">Agency Settings</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[135px]">
      <p className="font-['Hanken_Grotesk:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#b7bdc7] text-[14px] w-full">John Smith</p>
    </div>
  );
}
...
export default function Frame26() {
  return (
    <div className="bg-[#1c2128] content-stretch flex flex-col items-start justify-between px-0 py-[16px] relative size-full">
      <Frame1 />
      <Frame7 />
    </div>
  );
