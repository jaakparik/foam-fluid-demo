import svgPaths from "./svg-2whxb4a96m";
...
function ImgWrapper() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 size-[200px]" data-name="ImgWrapper">
      <ContentImg />
    </div>
  );
}
...
function MetricItem() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="MetricItem">
      <Eye />
      <div className="flex flex-col font-['Founders_Grotesk:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#303d4f] text-[14px] text-right whitespace-nowrap">
        <p className="leading-[20px] whitespace-pre">227k</p>
      </div>
    </div>
  );
}
...
function MetricItem1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="MetricItem">
      <Reach />
      <div className="flex flex-col font-['Founders_Grotesk:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#303d4f] text-[14px] text-right whitespace-nowrap">
        <p className="leading-[20px] whitespace-pre">190k</p>
      </div>
    </div>
  );
}
...
function MetricItem2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="MetricItem">
      <Click />
      <div className="flex flex-col font-['Founders_Grotesk:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#303d4f] text-[14px] text-right whitespace-nowrap">
        <p className="leading-[20px] whitespace-pre">468k</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Platforms">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Platforms">
          <g id="Vector">
            <path d={svgPaths.p208295b0} fill="url(#paint0_linear_2018_1573)" />
            <path d={svgPaths.p208295b0} fill="url(#paint1_linear_2018_1573)" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2018_1573" x1="0.625" x2="5.82692" y1="1.25" y2="11.6154">
            <stop stopColor="#D9D9D9" />
            <stop offset="0.0001" stopColor="#1200E7" />
            <stop offset="0.868122" stopColor="#ED1389" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_2018_1573" x1="1.85577" x2="8.99038" y1="18.2788" y2="0.307692">
...
function Frame3() {
  return (
    <div className="content-stretch flex font-['Founders_Grotesk:Regular',sans-serif] gap-[4px] items-center leading-[0] not-italic relative shrink-0 text-[14px] text-right whitespace-nowrap">
      <div className="flex flex-col justify-center relative shrink-0 text-[#8b94a2]">
        <p className="leading-[20px] whitespace-pre">Posted:</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#15191e]">
        <p className="leading-[20px] whitespace-pre">12/12/24</p>
      </div>
    </div>
  );
}
...
function Hover() {
  return (
    <div className="absolute content-stretch flex items-center opacity-0 right-[12px] top-[12px]" data-name="_hover">
      <Checkbox1 />
    </div>
  );
}

export default function ContentCardMetrics() {
  return (
    <div className="relative rounded-[12px] size-full" data-name="Content Card Metrics">
