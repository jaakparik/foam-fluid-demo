import svgPaths from "./svg-qnrt1o1u8w";
...
function ButtonSelectAll() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex gap-[4px] items-center justify-center px-[16px] py-[8px] relative rounded-[8px] shrink-0" data-name="Button select all">
...
function ButtonSecondary() {
  return (
    <div className="bg-[#f3f5f6] content-stretch flex gap-[4px] items-center justify-center pl-[12px] pr-[16px] py-[8px] relative rounded-[8px] shrink-0" data-name="Button secondary">
      <Icon />
...
function ButtonPrimary() {
  return (
    <div className="bg-[#155fef] content-stretch flex gap-[4px] items-center justify-center pl-[12px] pr-[16px] py-[8px] relative rounded-[8px] shrink-0" data-name="Button primary">
      <Icon1 />
